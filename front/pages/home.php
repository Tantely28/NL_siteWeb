	<section class="container-fluid banner">
		<div class="container">
			<div class="inner-banner col-md-5">
				<h1>Solution Digitale pesonnalisée pour votre entreprise</h1>
				<p>NL Technologie vous offre des services numériques<br> 
					dont l’activité s’oriente vers des conseils en technologie et<br> 
		...
		<div class="container">
			<div class="row text-center">
				<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
	            	<h4>Développement<br>sur Mesure Logiciels</h4><br><br>
                <div class="zoom-out">
                  <div>
                ...
                <a href="index.php?page=service" class="btn btn-danger" style="background-color: #000029; border:none; font-family:Eras Bold ITC;width: 200px; ">VOIR PLUS</a>
	          	...
	          	<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
	            	<h4>Développement<br>d'Applications Mobiles</h4><br><br>
                <div class="zoom-out">
                  <div>
                ...
                <a href="index.php?page=service" class="btn btn-danger" style="background-color: #000029; border:none; font-family:Eras Bold ITC;width: 200px; ">VOIR PLUS</a>
	          	...
	          	<div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
	            	<h4>Développement<br>d'Applications Web</h4><br><br>
                <div class="zoom-out">
                  <div>
                ...
                <br><br>	           
	            	<p class="text-muted">Conception et Développement<br>d'applications Web</p>
                <a href="index.php?page=service" class="btn btn-danger" style="background-color: #000029; border:none; font-family:Eras Bold ITC;width: 200px; ">VOIR PLUS</a>
				</div>
			</div>
	</div>
        ...
        <div class="container">
          <div class="row">
              <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading" style="color:white; ">Vous pouvez utiliser le formulaire de contact ci-dessous pour toute demande de
 renseingement.</h3>
              </div>
          </div>
          <div class="row">
